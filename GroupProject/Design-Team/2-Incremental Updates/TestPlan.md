...
| TC17 | Error message on an invalid item number (count). | 1.  Have an Item | 1. Check the number of Item in the list | Item name = blah <br> Item number = a | Error message is displayed. | N/A | N/A | Thomas Chu | N/A | N/A | N/A | Android Studio | Test case not valid. Item number input not implemented.
